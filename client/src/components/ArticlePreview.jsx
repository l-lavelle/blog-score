...
const ArticlePreview = ({ _id, postTitle, postText, postComments, upvotes, downvotes}) => {
  ...
  const {  unlikedata } = useQuery(USER_UNLIKED_POSTS);
  const  unlikedPostData = unlikedata

  console.log(unlikedPostData)
    ...
    <Card className="mb-3">
      <Card.Body>
        ...
        <div>
          ...
          <Button type="button" className="btn btn-secondary"onClick={()=>downvote(_id)} variant={btnTest}>
